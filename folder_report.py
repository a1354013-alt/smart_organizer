...
def export_folder_report_markdown(
    ...
    lines = [
        ...
        "",
        "| Original path | New path | Size | Last modified | Status | Malware scan | Scanner | Threat | Duplicate type | Duplicate reason | Failure reason |",
        "| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |",
    ]
    for row in rows:
        lines.append(
            ...
            + " | ".join(
                [
                    ...
                    escape_markdown_table_cell(row.get("malware_status")),
                    escape_markdown_table_cell(row.get("malware_scanner")),
                    escape_markdown_table_cell(row.get("malware_threat_name")),
        ...
        writer.writerow(
            {
                ...
                "malware_status": row.get("malware_status"),
                "malware_scanner": row.get("malware_scanner"),
                "malware_threat_name": row.get("malware_threat_name"),
                "malware_message": row.get("malware_message"),
